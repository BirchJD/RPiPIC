                  ...
                  INCLUDE  "../INCLUDE/P12F629.INC"

                  __CONFIG _INTRC_OSC_NOCLKOUT & _WDT_ON & _PWRTE_ON & _MCLRE_OFF & _BOREN_OFF & _CP_OFF & _CPD_OFF


;/********************************************************************************/
;/* Raspberry Pi PIC Programmer - Example LED Flash Program For Device PIC12F629 */
...
INT_HANDLE        BCF      STATUS, RP0          ; Select Register bank 0
                  ...
                  BTFSC    STATUS, Z
                  GOTO     INT_TIMER1_END
                  COMF     GPIO                 ; Invert LED.
                  DECF     FLASH_COUNT          ; Reduce flash count.
INT_TIMER1_END    BCF      PIR1, TMR1IF

INT_GPI           BTFSS    INTCON, GPIF         ; Did an input pin interupt trigger?
                  GOTO     INT_END
                  MOVF     FLASH_COUNT, F       ; Is a flashing process active?
                  BTFSS    STATUS, Z
                  GOTO     INT_GPI_END
...
INIT              MOVLW    0x0F                 ; Prescale watchdog timer.
                  ...
                  MOVWF    CMCON
                  CLRF     GPIO                 ; Clear GPIO port state.
