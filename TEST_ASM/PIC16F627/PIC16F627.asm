                  ...
                  INCLUDE  "../INCLUDE/P16F627.INC"

                  __CONFIG _FOSC_INTOSCIO & _WDT_ON & _PWRTE_ON & _MCLRE_OFF & _BOREN_OFF & _CP_OFF & _CPD_OFF


;/********************************************************************************/
;/* Raspberry Pi PIC Programmer - Example LED Flash Program For Device PIC16F627 */
...
INT_GPI           BTFSS    INTCON, INTF         ; Did an input pin interupt trigger?
                  ...
                  MOVWF    FLASH_COUNT
INT_GPI_END       MOVFW    PORTB                ; Read PORTB to allow interupt flag to be reset.
                  BCF      INTCON, INTF
